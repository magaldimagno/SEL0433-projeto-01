...
INICIO:
	...
	CLR P3.3 
	CLR P3.4
	; Ativa e configura o contador externo: Bit 6 (C/T) em nivel alto, para atuar como contador. Bits 5 e 4 (M1 e M0) estao em '1' e '0', configurando o Modo 2 (8 bits com reload automático)
	MOV TMOD, #01100000b ; Contador no modo 1 
	SETB TR1
	; Escrevendo 246 no contador, para ajustar o overflow à sequência de 0 a 9:
	MOV TH1, #0F6h 
	MOV TL1, #0F6h
